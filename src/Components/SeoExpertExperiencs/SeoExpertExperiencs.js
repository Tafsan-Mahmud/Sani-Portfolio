...
import { faUsersCog, faChartLine, faLocationArrow, faLongArrowAltRight } from '@fortawesome/free-solid-svg-icons'
        ...
        <div id="Seo-Expert-Experiencs-sectioon" className="pt-5 pb-5">
            <div className="container pt-5 pb-5">
                <div className="row pt-4 pb-4 d-flex align-items-center justify-content-center">
                    <div data-aos="fade-right" data-aos-anchor-placement="top-bottom"  className="col-md-4 col-sm-6col-sm-6 for-SEOEXPRT-pic">
